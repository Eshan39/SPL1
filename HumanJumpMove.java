...
public class HumanJumpMove {
	
		public ArrayList<Integer> bestWay[]=new ArrayList[64];
		public int[] counter=new int[64];
		public int node;
		
		public  HumanJumpMove(int source,int [] counter,ArrayList<Integer>[] bestWay) {
						...
						if(path[tempX1][j]!=-1) {
							...
							if(path[tempX2][j]!=-1) {
								...
								if(tempX2!=-1&&tempX3!=-1) {
									if((Altarr2[tempX2][2]==2||Altarr2[tempX2][2]==3)&&Altarr2[tempX3][2]==0) {
			...
			while(true){
				...
				for(int k=0;k<8;k++) {
					...
					if(tempX2!=-1&&tempX3!=-1) {
						...
						if((Altarr[tempX2][2]==2||Altarr[tempX2][2]==3)&&Altarr[tempX3][2]==0) {
